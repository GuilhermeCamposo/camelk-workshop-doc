...
= Lab 02 - Messaging and Config Files

Connect to a message broker and log the message content.
...
Let's use AMQ's web console to send messages to our queue. Open it using the route.
